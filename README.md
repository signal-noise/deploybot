...
`cimon set xxx yyy` allows settings to be set up; at the moment a `baseurl` and
`url`s for any environments that don't rely on subdomains of the baseurl should
be setup.
